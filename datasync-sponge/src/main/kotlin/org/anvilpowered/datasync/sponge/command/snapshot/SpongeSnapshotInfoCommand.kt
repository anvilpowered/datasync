...
class SpongeSnapshotInfoCommand : CommonSnapshotInfoCommand<Text, User, Player, CommandSource>(), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonSnapshotCommandNode.INFO_DESCRIPTION))
        val USAGE: Text = Text.of(CommonSnapshotCommandNode.INFO_USAGE)
    }
