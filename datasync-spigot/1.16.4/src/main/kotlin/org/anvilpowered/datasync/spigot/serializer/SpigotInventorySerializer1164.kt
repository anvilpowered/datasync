...
class SpigotInventorySerializer1164 : CommonInventorySerializer<String, Player, Inventory, ItemStack>() {
    ...
    override fun deserializeInventory(snapshot: Snapshot<*>, inventory: Inventory, fallbackItemStack: ItemStack): Boolean {
        ...
        val root: NBTTagCompound
        try {
            root = NBTCompressedStreamTools.a(DataInputStream(ByteArraySizedInputStream(snapshot.inventory)) as DataInput)
            ...
            for (i in 0 until INVENTORY_SLOTS) {
                ...
                inventory.setItem(i,
                    CraftItemStack.asBukkitCopy(net.minecraft.server.v1_16_R3.ItemStack.a(
