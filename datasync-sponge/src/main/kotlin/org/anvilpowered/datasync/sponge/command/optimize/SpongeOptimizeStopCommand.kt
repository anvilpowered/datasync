...
class SpongeOptimizeStopCommand : CommonOptimizeStopCommand<Text, User, CommandSource>(), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonOptimizeCommandNode.STOP_DESCRIPTION))
