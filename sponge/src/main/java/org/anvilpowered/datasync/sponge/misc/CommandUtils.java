...
package org.anvilpowered.datasync.sponge.misc;
...
public class CommandUtils {
    ...
    public boolean hasPermissionForSubCommands(CommandSource source) {
        return source instanceof ConsoleSource
            || source.hasPermission(DataSyncKeys.SNAPSHOT_BASE_PERMISSION.getFallbackValue())
            || source.hasPermission(DataSyncKeys.MANUAL_OPTIMIZATION_BASE_PERMISSION.getFallbackValue())
            || source.hasPermission(DataSyncKeys.LOCK_COMMAND_PERMISSION.getFallbackValue())
            || source.hasPermission(DataSyncKeys.RELOAD_COMMAND_PERMISSION.getFallbackValue());
    }
}
