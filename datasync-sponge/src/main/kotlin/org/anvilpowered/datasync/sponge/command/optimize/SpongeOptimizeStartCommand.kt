...
class SpongeOptimizeStartCommand : CommonOptimizeStartCommand<Text, User, Player, CommandSource>(), CommandCallable {

    companion object {
        val DESCRIPTION: Optional<Text> = Optional.of(Text.of(CommonOptimizeCommandNode.START_DESCRIPTION))
        val USAGE: Text = Text.of(CommonOptimizeCommandNode.START_DESCRIPTION)
    }
