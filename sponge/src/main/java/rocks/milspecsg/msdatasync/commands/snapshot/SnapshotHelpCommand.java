...
public class SnapshotHelpCommand implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource source, CommandContext context) throws CommandException {
        Map<List<String>, CommandSpec> commands = SyncCommandManager.snapshotSubCommands;
        ...
        for(List<String> aliases : commands.keySet()){
            ...
            Text commandHelp = Text.builder()
                .append(Text.builder()
                    .append(Text.of(TextColors.GREEN, "/sync snapshot " + replace))
                    .build())
                .append(Text.builder()
                    .append(Text.of(TextColors.GOLD, " - " + commandSpec.getShortDescription(source).get().toPlain() + "\n"))
                    .build())
                .append(Text.builder()
                    .append(Text.of(TextColors.GRAY, "Usage: /sync snapshot " + replace + " " + commandSpec.getUsage(source).toPlain()))
                    .build())
                .build();
        ...
        PaginationList.Builder paginationBuilder = paginationService.get().builder().title(Text.of(TextColors.GOLD, "MSDataSync Snapshot - MilspecSG")).padding(Text.of(TextColors.DARK_GREEN, "-")).contents(helpList).linesPerPage(10);
