...
public abstract class ConfigKeys extends rocks.milspecsg.msrepository.api.config.ConfigKeys {
    ...
    public static final int MONGODB_USE_AUTH = 25;
    public static final int SNAPSHOT_MIN_COUNT = 30;
    public static final int SNAPSHOT_OPTIMIZATION_STRATEGY = 31;
    public static final int SNAPSHOT_UPLOAD_INTERVAL = 32;
    public static final int SERVER_NAME = 49;
