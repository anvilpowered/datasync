...
public class SpigotInventorySerializer1164
    ...
    public boolean deserializeInventory(Snapshot<?> snapshot, Inventory inventory, ItemStack fallbackItemStack) {
        ...
        NBTTagCompound root;
        try {
            root = NBTCompressedStreamTools.a((DataInput) new DataInputStream(new ByteArraySizedInputStream(snapshot.getInventory())));
